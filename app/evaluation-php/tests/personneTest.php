...
final class personneTest extends TestCase
{
    ...
    public function testCreateur(): void
    {
        ...
        $expectedDate = new DateTime('1989-05-23 00:00:00');
        
        $this->assertSame('Isabelle', $personne->prenom);
        $this->assertSame('PETIT', $personne->nom);
        
        // Comparaison des parties de la date séparément
        $this->assertSame($expectedDate->format('Y'), $personne->date->format('Y'));
        $this->assertSame($expectedDate->format('m'), $personne->date->format('m'));
        $this->assertSame($expectedDate->format('d'), $personne->date->format('d'));
